...
# Load the CSV
df = pd.read_csv("results_gpt_wee_small.csv")
...
# Save to file
result_df_diff.to_csv("mean_SD_CI95_gpt_wee_small_dif.csv", index=False)

print("\nResults saved to 'mean_SD_CI95_gpt_wee_small_dif.csv'.")